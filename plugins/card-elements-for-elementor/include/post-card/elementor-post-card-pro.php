...
<div class="post-card-style-pro text-center">
    ...
    <button class="live-preview"><a class="preview-link" href="https://elementor.techeshta.com/card-elements/post-card/" target="_blank"><?php echo esc_html__('Live Preview', 'card-elements-for-elementor'); ?></a></button>
</div>
<?php } ?>
<!-- End Post Card -->
